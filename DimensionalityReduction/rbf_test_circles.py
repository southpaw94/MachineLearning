...
plt.scatter(X[y==0, 0], X[y==0, 1], color='red', marker='^', alpha=0.5, s = 50)
plt.scatter(X[y==1, 0], X[y==1, 1], color='blue', marker='o', alpha=0.5, s = 50)
plt.show()
...
ax[0].scatter(X_spca[y==0, 0], X_spca[y == 0, 1], color='red', marker='^', alpha=0.5, s = 50)
ax[0].scatter(X_spca[y==1, 0], X_spca[y == 1, 1], color='blue', marker='o', alpha=0.5, s = 50)

ax[1].scatter(X_spca[y==0, 0], np.zeros((500, 1)) + 0.02, color='red', marker='^', alpha=0.5, s = 50)
ax[1].scatter(X_spca[y==1, 0], np.zeros((500, 1)) - 0.02, color='blue', marker='o', alpha=0.5, s = 50)
